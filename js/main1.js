...
function initPage() {
    ...
    dd = document.querySelectorAll('.exit-button');
    if (dd) {
...
function setupWebshopClickListener() {
    ...
    ed = document.querySelector('.shop .selected-shop-item .content');
    if (ed) {
...
function validateAddress() {
    ...
    var cit = document.getElementsByName("city")[0].value;
    if (coun.length * cit.length === 0) {
        return "Missing Country or City/Provine/State! \n";
    }
    return "";
}
