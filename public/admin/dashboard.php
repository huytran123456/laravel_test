...
$querypro = $dbh -> prepare($sqlpro);;
$querypro->execute();
$results1=$querypro->fetchAll(PDO::FETCH_OBJ);
$regbd33=$querypro->rowCount();
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($regbd33);?></div>
													<div class="stat-panel-title text-uppercase">Manage Products</div>
												</div>
											</div>
											<a href="manageproduct.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
									</div>
